    ...
    <div class="register h-100 d-flex align-items-center justify-content-center container py-md-0 py-3">
        <div class="row rounded-5 shadow-lg p-3 my-5">
            <div class="d-block pb-3">
                ...
                <a href="<?php echo (substr($_SERVER['HTTP_REFERER'], strrpos($_SERVER['HTTP_REFERER'], '/')) === '/sign-in-account') ? 'sign-in' : url()->previous();  ?>" class="previous text-decoration-none link-secondary">بازگشت<span class="h4">&#8592;</span></a>
                <?php } else { ?>
            ...
            <div class="col-md-6 col-12 text-md-end text-center">
                <b>ورود</b>
                <form action="{{ url('sign-in-account/') }}" method="post" class="m-md-0 m-auto">
                    {{ csrf_field() }}
                    ...
                    <div class="mt-4 text-center ps-4">
                        <button type="submit" class="btn btn-outline-success btn-lg" id="btn_register">ورود</button>
                        <button type="submit" class="btn btn-outline-primary btn-lg d-block m-md-0 me-4" id="send_code">ارسال کد</button>
                    </div>
                </form>
                <div class="mt-5 mb-2">
                    <b>آیا حساب کاربری ندارید؟</b>
                    <a href="{{ url('sign-up') }}" class="text-decoration-none">ثبت‌نام</a>
                </div>
            </div>
